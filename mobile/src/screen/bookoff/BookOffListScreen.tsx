            ...
            {bookOffs?.map((item, index) => (
                <View key={index} style={styles.bookOffItem}>
                    <View style={styles.dateContainer}>
                        <Text style={styles.dayText}>Request on {item.date}</Text>
                        <Text style={styles.dayText}>From {moment.unix(Number(item.start)).format('DD/MM/YYYY')}</Text>
                        <Text style={styles.dayText}>To {moment.unix(Number(item.end)).format('DD/MM/YYYY')}</Text>
                    </View>
