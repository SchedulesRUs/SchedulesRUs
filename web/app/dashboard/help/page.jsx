...
const Page = () => {
    ...
    const styles = {
        ...
        separator: {
            border: '0',
            height: '1px',
            backgroundImage: 'linear-gradient(to right, rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25))',
            margin: '20px 0',
        },
        boldText: {
            fontWeight: 'bold',
        ...
        <div>
            ...
            <div style={styles.contactBox}>
                ...
                <div style={styles.contactItem}>
                    <div>
                        <h3 style={{ ...styles.contactHeader, ...styles.boldText }}>Paradon Meeanan</h3>
                ...
                <div style={styles.contactItem}>
                    <div>
                    <h3 style={{ ...styles.contactHeader, ...styles.boldText }}>Felix Zhang</h3>
                        <p style={styles.contactText}>
                ...
                <div style={styles.contactItem}>
                    <div>
                        <h3 style={{ ...styles.contactHeader, ...styles.boldText }}>Khit Klinsang</h3>
                        <p style={styles.contactText}>
                            Email: <a style={styles.link(isHovering.email3)}
                                      onMouseEnter={() => setIsHovering({ ...isHovering, email3: true })}
                                      onMouseLeave={() => setIsHovering({ ...isHovering, email3: false })}
                                      href={`mailto:khitdhikhun.klinsang@edu.sait.ca`}>khitdhikhun.klinsang@edu.sait.ca</a>
                        </p>
                        <p style={styles.contactText}>
                            Number: <a style={styles.link(isHovering.phone3)}
                                       onMouseEnter={() => setIsHovering({ ...isHovering, phone3: true })}
                                       onMouseLeave={() => setIsHovering({ ...isHovering, phone3: false })}
                                       href="tel:+1403-3333-3333">403-3333-3333</a>
                        </p>
                    </div>
                    <div style={styles.imageContainer}>
